...
class HyperparameterTuner:
    ...
    def __init__(self, model_type='xgboost', n_trials=50, cv_folds=5, scoring='roc_auc'):
        """
    ...
    def tune_with_optuna(self, X, y, timeout=300):
        ...
        """
        self.logger.info(f"Starting hyperparameter tuning with Optuna for {self.model_type}")
    ...
    def tune_with_random_search(self, X, y):
        ...
        Returns:
            Best model parameters and best score
        """
        self.logger.info(f"Starting hyperparameter tuning with RandomizedSearchCV for {self.model_type}")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Perform hyperparameter tuning for credit scoring models.")
    parser.add_argument(
        "--train_data_path",
        type=str,
