...
class PredictionInput(BaseModel):
    ...
    loan_id: Optional[str] = Field(
        None,
        description="Unique identifier for the loan, used for feature store lookup",
    )
    ...
    delinq_2yrs: int = Field(
        ...,
        description="The number of 30+ day past-due incidences of delinquency in the borrower's credit file",
        ge=0,
    )
