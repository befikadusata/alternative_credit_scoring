...
def load_model_from_registry(
    ...
    logger.info(
        f"Attempting to load model '{model_name}' version/alias '{model_version}' from registry"
    )
...
def get_model_version_info(
    ...
    try:
        ...
        logger.error(
            f"Failed to get model version info for '{model_name}' version '{model_version}': {str(e)}"
        )
        raise
