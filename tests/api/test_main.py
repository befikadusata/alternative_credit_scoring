...
def dummy_model_path():
    ...
    feature_names_excluding_loan_id = [field for field in PredictionInput.__fields__ if field != "loan_id"]
    n_features_needed = len(feature_names_excluding_loan_id)
    X, y = make_classification(n_samples=100, n_features=n_features_needed, n_informative=5, n_redundant=0, random_state=42)
...
def mock_models(dummy_model_path):
    ...
    mock_challenger_model.predict.return_value = np.array([0]) # Prediction: 0 (No Default)

    with patch('src.api.main.champion_model', real_dummy_model), \
...
def test_predict_endpoint_no_redis(client, mock_models, mock_redis):
    ...
    payload = {
        "input": {
            "loan_amnt": 12000.0, "term": "36 months", "int_rate": 10.0, "installment": 300.0,
            "grade": "B", "sub_grade": "B2", "emp_length": 5.0, "home_ownership": "MORTGAGE",
            "annual_inc": 75000.0, "verification_status": "Verified", "purpose": "debt_consolidation",
            "dti": 15.0, "delinq_2yrs": 0, "inq_last_6mths": 1, "open_acc": 8, "pub_rec": 0,
            "revol_bal": 12000, "revol_util": 50.0, "total_acc": 20, "initial_list_status": "f",
            "total_pymnt": 1000.0, "total_pymnt_inv": 1000.0, "total_rec_prncp": 800.0,
            "total_rec_int": 200.0, "total_rec_late_fee": 0.0, "recoveries": 0.0,
            "collection_recovery_fee": 0.0, "last_pymnt_amnt": 300.0
        }
    }
...
def test_predict_endpoint_with_redis_hit(client, mock_models, mock_redis):
    ...
    cached_features = PredictionInput(**{
        "loan_id": loan_id,
        "loan_amnt": 9999.0, "term": "60 months", "int_rate": 20.0, "installment": 400.0,
        "grade": "E", "sub_grade": "E1", "emp_length": 1.0, "home_ownership": "RENT",
        "annual_inc": 40000.0, "verification_status": "Not Verified", "purpose": "credit_card",
        "dti": 35.0, "delinq_2yrs": 2, "inq_last_6mths": 4, "open_acc": 15, "pub_rec": 1,
        "revol_bal": 20000, "revol_util": 80.0, "total_acc": 25, "initial_list_status": "w",
        "total_pymnt": 500.0, "total_pymnt_inv": 500.0, "total_rec_prncp": 100.0,
        "total_rec_int": 400.0, "total_rec_late_fee": 20.0, "recoveries": 0.0,
        "collection_recovery_fee": 0.0, "last_pymnt_amnt": 400.0
    })
    ...
    payload = {
        "input": {
            ...
            # ... other fields can be different or missing
             "term": "36 months", "int_rate": 10.0, "installment": 300.0,
            "grade": "B", "sub_grade": "B2", "emp_length": 5.0, "home_ownership": "MORTGAGE",
            "annual_inc": 75000.0, "verification_status": "Verified", "purpose": "debt_consolidation",
            "dti": 15.0, "delinq_2yrs": 0, "inq_last_6mths": 1, "open_acc": 8, "pub_rec": 0,
            "revol_bal": 12000, "revol_util": 50.0, "total_acc": 20, "initial_list_status": "f",
